    ...
    <form action="<?php $_PHP_SELF ?>" method="post" id="form1" >
            ...
            <div class="form-group">
              <br>  
                ...
                Confirm Password<input type='password' name='CPassword' class="form-control"><br>
				Mobile No<input type='phone' name='mobileno' class="form-control"><br>
                <button type="submit" name="add_contact" class="btn btn-primary">Sign Up</button><br><br>
